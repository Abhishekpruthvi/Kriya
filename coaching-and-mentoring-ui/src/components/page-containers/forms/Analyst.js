...
function Analyst() {
  ...
  let fields = [
    ...
    },
    {
      type: "textarea",
      name: "purpose",
      label: "Purpose of working with us?",
      grid: {
        xs: 12,
        sm: 3,
        style: textFieldStyles
...

    {
        type: "textarea",
        name: "analysisArea",
        label: "Which area would u like to get analyzed by our team?",
        grid: {
          xs: 12,
          sm: 4,
          style: textFieldStyles
  ...
  const handleSubmit = (values, resetForm, setSubmitting) => {
    ...
    KriyaService.contactAnalyst(values).then(response => {
