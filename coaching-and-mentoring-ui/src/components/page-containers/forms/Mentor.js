...
function Mentor() {
  ...
  let fields = [
    ...
    },
    {
      type: "text",
      name: "mentoringType",
      label: "Personal Mentoring OR Mentoring for the Institute/Organization?",
      grid: {
        xs: 12,
        sm: 6,
        style: textFieldStyles
    ...
    },
    {
        type: "textarea",
        name: "instituteInfo",
        label: "If Institute, provide your institute information",
        grid: {
          xs: 12,
          sm: 3,
      ...
      },
    {
      type: "textarea",
      name: "reason",
      label: "Reason for getting mentored by us",
      grid: {
        xs: 12,
        sm: 2,
        style: textAreaStyles
  ...
  const handleSubmit = (values, resetForm, setSubmitting) => {
    ...
    KriyaService.contactMentor(values).then(response => {
